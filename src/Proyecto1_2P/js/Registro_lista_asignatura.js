...
window.addEventListener('DOMContentLoaded', async (e) => {
  ...
  onGetTasks((querySnapshot) => {
    ...
    querySnapshot.forEach(doc => {
      ...
      <div id="tarjeta" class="card card-body mt-2 border-primary">
      <h3><b class="t1">ASIGNATURA REGISTRADA</b></h3>
      <div class="info">
      ...
      <div>
      <button id="btneli" class="btn btn-primary btn-borrar" data-id="${asignatura.id}" >🗑️ Eliminar </button>
      <button id="btnedi" class="btn btn-primary btn-editar" data-id="${asignatura.id}">  Editar </button>
